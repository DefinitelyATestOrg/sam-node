...
func TestProofOfAuthorizationRequestListWithOptionalParams(t *testing.T) {
	...
	_, err := client.ProofOfAuthorizationRequests.List(context.TODO(), samgo.ProofOfAuthorizationRequestListParams{
		CreatedAt: samgo.F(samgo.ProofOfAuthorizationRequestListParamsCreatedAt{
