...
export const handler = async (client: Sam, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.messages.batchesBetaTrue.list(body)));
};
