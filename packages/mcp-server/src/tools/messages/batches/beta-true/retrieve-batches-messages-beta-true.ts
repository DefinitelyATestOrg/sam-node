...
export const handler = async (client: Sam, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.messages.batches.betaTrue.retrieve(message_batch_id, body)),
  );
};
