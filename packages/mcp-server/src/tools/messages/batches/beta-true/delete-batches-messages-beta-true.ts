...
export const handler = async (client: Sam, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.messages.batches.betaTrue.delete(message_batch_id, body)),
    );
  } catch (error) {
