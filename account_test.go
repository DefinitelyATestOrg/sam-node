...
func TestAccountUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Accounts.Update(
		...
		samgo.AccountUpdateParams{
			Name: samgo.F("My renamed account"),
		},
	)
	if err != nil {
		var apierr *samgo.Error
...
func TestAccountListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Accounts.List(context.TODO(), samgo.AccountListParams{
		CreatedAt: samgo.F(samgo.AccountListParamsCreatedAt{
