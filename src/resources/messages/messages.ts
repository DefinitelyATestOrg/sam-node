...
export class Messages extends APIResource {
  ...
  batchesBetaTrue: BatchesBetaTrueAPI.BatchesBetaTrue = new BatchesBetaTrueAPI.BatchesBetaTrue(this._client);
...
export interface MessageCreateResponse {
   ...
   */
  content: Array<
    | MessageCreateResponse.ResponseTextBlock
    | MessageCreateResponse.ResponseToolUseBlock
    | MessageCreateResponse.ResponseThinkingBlock
    | MessageCreateResponse.ResponseRedactedThinkingBlock
  >;
...
export interface MessageCountTokensBetaResponse {
  /**
   * The total number of tokens across the provided list of messages, system prompt,
   * and tools.
   */
...
export interface MessageCreateParams {
   ...
   */
  system?: string | Array<MessageCreateParams.UnionMember1>;
   ...
   * for details.
   */
  thinking?: MessageCreateParams.ThinkingConfigEnabled | MessageCreateParams.ThinkingConfigDisabled;
  ...
  tool_choice?:
    ...
    | MessageCreateParams.ToolChoiceNone;
   ...
   */
  tools?: Array<
    MessageCreateParams.Tool | MessageCreateParams.BashTool20250124 | MessageCreateParams.TextEditor20250124
  >;
  ...
  export namespace Message {
    ...
    export namespace RequestDocumentBlock {
      ...
      export interface ContentBlockSource {
        content: string | Array<ContentBlockSource.RequestTextBlock | ContentBlockSource.RequestImageBlock>;
...
export interface MessageCountTokensParams {
   ...
   * [guide to system prompts](https://docs.anthropic.com/en/docs/system-prompts).
   */
  system?: string | Array<MessageCountTokensParams.UnionMember1>;
   ...
   * for details.
   */
  thinking?: MessageCountTokensParams.ThinkingConfigEnabled | MessageCountTokensParams.ThinkingConfigDisabled;
   ...
   */
  tool_choice?:
    | MessageCountTokensParams.ToolChoiceAuto
    | MessageCountTokensParams.ToolChoiceAny
    | MessageCountTokensParams.ToolChoiceTool
    | MessageCountTokensParams.ToolChoiceNone;
  ...
  tools?: Array<
    ...
    | MessageCountTokensParams.BashTool20250124
    | MessageCountTokensParams.TextEditor20250124
  >;
...
export interface MessageCountTokensBetaParams {
  /**
   * Body param: Input messages.
   *
   * Our models are trained to operate on alternating `user` and `assistant`
   ...
   * messages in the Messages API.
   */
  messages: Array<MessageCountTokensBetaParams.Message>;
   ...
   * [guide to system prompts](https://docs.anthropic.com/en/docs/system-prompts).
   */
  system?: string | Array<MessageCountTokensBetaParams.UnionMember1>;
   ...
   */
  thinking?:
    | MessageCountTokensBetaParams.BetaThinkingConfigEnabled
    | MessageCountTokensBetaParams.BetaThinkingConfigDisabled;
   ...
   */
  tool_choice?:
    | MessageCountTokensBetaParams.BetaToolChoiceAuto
    | MessageCountTokensBetaParams.BetaToolChoiceAny
    | MessageCountTokensBetaParams.BetaToolChoiceTool
    | MessageCountTokensBetaParams.BetaToolChoiceNone;
   ...
   */
  tools?: Array<
    | MessageCountTokensBetaParams.BetaTool
    | MessageCountTokensBetaParams.BetaComputerUseTool20241022
    | MessageCountTokensBetaParams.BetaBashTool20241022
    | MessageCountTokensBetaParams.BetaTextEditor20241022
    | MessageCountTokensBetaParams.BetaComputerUseTool20250124
    | MessageCountTokensBetaParams.BetaBashTool20250124
    | MessageCountTokensBetaParams.BetaTextEditor20250124
  >;
...
export namespace MessageCountTokensBetaParams {
  export interface Message {
    content:
      | string
      | Array<
...
Messages.BatchesBetaTrue = BatchesBetaTrue;
...
export declare namespace Messages {
  ...
  export {
    BatchesBetaTrue as BatchesBetaTrue,
