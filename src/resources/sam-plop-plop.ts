...
export class SamPlopPlop extends APIResource {
  ...
  createMessage(
  ...
  ): APIPromise<SamPlopPlopCreateMessageResponse> {
    const {
    ...
    return this._client.post('/v1/sam-plop-plop', {
      body,
      ...options,
...
export interface SamPlopPlopCreateMessageResponse {
  /**
   ...
   */
  content: Array<
    | SamPlopPlopCreateMessageResponse.ResponseTextBlock
    | SamPlopPlopCreateMessageResponse.ResponseToolUseBlock
    | SamPlopPlopCreateMessageResponse.ResponseThinkingBlock
    | SamPlopPlopCreateMessageResponse.ResponseRedactedThinkingBlock
  >;
...
export namespace SamPlopPlopCreateMessageResponse {
...
export interface SamPlopPlopCreateMessageParams {
  /**
   ...
   */
  messages: Array<SamPlopPlopCreateMessageParams.Message>;
   ...
   */
  metadata?: SamPlopPlopCreateMessageParams.Metadata;
   ...
   */
  system?: string | Array<SamPlopPlopCreateMessageParams.UnionMember1>;
   ...
   */
  thinking?:
    | SamPlopPlopCreateMessageParams.ThinkingConfigEnabled
    | SamPlopPlopCreateMessageParams.ThinkingConfigDisabled;
   ...
   */
  tool_choice?:
    | SamPlopPlopCreateMessageParams.ToolChoiceAuto
    | SamPlopPlopCreateMessageParams.ToolChoiceAny
    | SamPlopPlopCreateMessageParams.ToolChoiceTool
    | SamPlopPlopCreateMessageParams.ToolChoiceNone;
   ...
   */
  tools?: Array<
    | SamPlopPlopCreateMessageParams.Tool
    | SamPlopPlopCreateMessageParams.BashTool20250124
    | SamPlopPlopCreateMessageParams.TextEditor20250124
  >;
...
export namespace SamPlopPlopCreateMessageParams {
...
export declare namespace SamPlopPlop {
  export {
