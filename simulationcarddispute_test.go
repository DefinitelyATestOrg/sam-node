...
func TestSimulationCardDisputeActionWithOptionalParams(t *testing.T) {
	...
	_, err := client.Simulations.CardDisputes.Action(
		...
		samgo.SimulationCardDisputeActionParams{
			Status:      samgo.F(samgo.SimulationCardDisputeActionParamsStatusRejected),
			Explanation: samgo.F("This was a valid recurring transaction"),
		},
	)
	if err != nil {
