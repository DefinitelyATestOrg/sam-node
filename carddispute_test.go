...
func TestCardDisputeNew(t *testing.T) {
	...
	_, err := client.CardDisputes.New(context.TODO(), samgo.CardDisputeNewParams{
		DisputedTransactionID: samgo.F("transaction_uyrp7fld2ium70oa7oi"),
		Explanation:           samgo.F("Unauthorized recurring transaction."),
	})
	if err != nil {
...
func TestCardDisputeListWithOptionalParams(t *testing.T) {
	...
	_, err := client.CardDisputes.List(context.TODO(), samgo.CardDisputeListParams{
		CreatedAt: samgo.F(samgo.CardDisputeListParamsCreatedAt{
		...
		Status: samgo.F(samgo.CardDisputeListParamsStatus{
			In: samgo.F([]samgo.CardDisputeListParamsStatusIn{samgo.CardDisputeListParamsStatusInPendingReviewing, samgo.CardDisputeListParamsStatusInAccepted, samgo.CardDisputeListParamsStatusInRejected}),
		}),
	})
	if err != nil {
		var apierr *samgo.Error
