...
describe('resource messages', () => {
  ...
  test('countTokensBeta: only required params', async () => {
    const responsePromise = client.messages.countTokensBeta({
      messages: [{ content: 'string', role: 'user' }],
      model: 'claude-3-7-sonnet-20250219',
    });
    const rawResponse = await responsePromise.asResponse();
  ...
  test('countTokensBeta: required and optional params', async () => {
